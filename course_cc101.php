        ...
        <section>
            <div class="row" style="height: 100vh;">
                ...
                <div class="col">
                    <?php echo $msg; ?>
                    <div>
                        <font size="+4"><strong><?php echo $coursecode; ?> - <?php echo $coursename; ?></strong></font>
                    </div>
                    <p><?php echo $coursedesc; ?></p>
                    <br>
                    <a href="library/core/CO101-CreativeBibleStudy.pdf" target="_blank">Download Study Materials</a>
                    <br><br>
                    <?php
                    //$lessnum = 1;
                    ?>
                    <div id="accordion">
                        ...
                        /*echo "<br><br>lessonid = ".$lessonid."<br>";
                    ...
                    echo "isvalid = ".$isvalid."<br>";*/
                        ...
                        // Attempt select query execution
                        $sql = "SELECT * FROM courselessons WHERE courseid = '$courseid' AND  isvalid = 'Yes' ORDER BY lessonnumber ASC";
                        if ($result = mysqli_query($mysqli, $sql)) {
                            if (mysqli_num_rows($result) > 0) {
                                    ...
                                    <div class="card">
                                        ...
                                        <div id="less<?php echo $lessonnumber; ?>" class="collapse" aria-labelledby="lesson<?php echo $lessonnumber; ?>" data-parent="#accordion">
                                            <div class="card-body">
                                                ...
                                                ?>
                                                    <br><br>
                                                    <iframe width="450" height="271" src="<?php echo $videourl; ?>" title="IHN Bible College" frameborder="0" allow="accelerometer;  clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                                                <?php
                                                }
                                                ?>
                                                <br><br>
                        ...
                        <?php
                            ...
                            echo "ERROR: Was not able to execute Query on line #127. "; // . mysqli_error($mysqli);
                        }
                        // End attempt select query execution
                        ?>
                    </div>
