...
function main_form() {
    ...
    $sql = "SELECT schedtitle, schedule FROM $notes_tablename";
                        ...
                        <div class="card">
                            <form action="<?php echo $PHP_SELF ?>" method="post">
                                <div class="card-body release-body-height">
                                    <h4 class="card-title"><input type="text" name="schedtitle" id="schedtitle" value="<?php echo $schedtitle; ?>"></h4>
                                    <textarea name="schedule" id="coursenews" style="width: 100%; height: 400px;"><?php echo $schedule; ?></textarea>
                                </div>
                                <div class="card-footer">
                                    <div class="d-grid gap-2">
                                        ...
                                        <button name="action" type="submit" style="width: 100%;" class="btn btn-success btn-block" value="updatenews">Update Zoom Schedule</button>
                                        </span>
                                    </div>
                                </div>
                            </form>
...
function current_news(){
    ...
    $schedtitle = addslashes($_POST['schedtitle']);
    $schedule = addslashes($_POST['schedule']);

    if (empty($schedtitle) || $schedtitle == null) {
    ...
    // Attempt select query execution
    $sql = "UPDATE $notes_tablename SET schedtitle = '$schedtitle', schedule = '$schedule'";
    if($result = mysqli_query($mysqli, $sql)){
