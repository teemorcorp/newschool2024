...
function main_form() {
    ...
    $sql = "SELECT newtitle, newadded FROM $notes_tablename";
                        ...
                        <div class="card">
                            <form action="<?php echo $PHP_SELF ?>" method="post">
                                <div class="card-body release-body-height">
                                    <h4 class="card-title"><input type="text" name="newtitle" id="newtitle" value="<?php echo $newtitle; ?>"></h4>
                                    <textarea name="newadded" id="coursenews" style="width: 100%; height: 400px;"><?php echo $newadded; ?></textarea>
                                </div>
                                <div class="card-footer">
                                    <div class="d-grid gap-2">
                                        ...
                                        <button name="action" type="submit" style="width: 100%;" class="btn btn-success btn-block" value="updatenews">Update Newly Added</button>
                                        </span>
                                    </div>
                                </div>
                            </form>
...
function current_news(){
    ...
    $newadded = addslashes($_POST['newadded']);
    ...
    // Attempt select query execution
    $sql = "UPDATE $notes_tablename SET newtitle = '$newtitle', newadded = '$newadded'";
    if($result = mysqli_query($mysqli, $sql)){
