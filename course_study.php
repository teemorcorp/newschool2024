                                        ...
                                        while($row = mysqli_fetch_array($result)){
                                            ...
                                            <div>
                                                ...
                                                if(!empty($videourl)){
                                                    ?>
                                                    <br><br>
                                                    <iframe width="450" height="271" src="vids/<?php echo $videourl; ?>" title="IHN Bible College" frameborder="0" allow="accelerometer; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                                                    <?php
                                                }
                                                ?>
                                                <br><br>
                                                ...
                                                if(!empty($fileurl)){
                                                    ?>
                                                    <br><br>
                                                    <a href="library/core/<?php echo $fileurl; ?>" target="_blank">Download Study Materials</a>
                                                    <?php
                                                }
